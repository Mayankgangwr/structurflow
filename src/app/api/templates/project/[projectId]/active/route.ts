...
export async function GET(req: NextRequest, { params }: RouteParams) {
    try {
        ...
        const data = await templateService.getActiveProjectTemplate(organizationId, projectId);
        ...
        console.error("[GET /api/templates/project/[projectId]/active error]:", error);
        return NextResponse.json({ success: false, message: "Failed to fetch active template" }, { status: 500 });
    }
}
