...
const UploadDocument: React.FC<IUploadDocumentProps> = ({ projectId }) => {
    return (
        <>
            ...
            <div
                className="flex-1 w-full border-2 border-dashed border-primary/40 rounded-xl p-xl flex flex-col items-center justify-center text-center gap-md bg-primary/2 hover:border-primary hover:bg-primary/5 transition-all cursor-pointer group min-h-[250px] lg:min-h-[300px]">
                <div
